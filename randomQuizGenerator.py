#! python 3
# randomqUIZgENERATOR.PY  - cria perguntas e repostas
# em ordem aleatorias, justamente com os gabaritos contendo as repostas.
import random

#os Dados para as provas. As chaves são os estados e os valores são 
...
for quizNum in range(35):
    #Crias os arquivos com as provas e os gabarito das respostas.
